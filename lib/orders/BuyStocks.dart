...
class BuyStocks extends StatefulWidget {
 ...
 final String TradingSymbol;
  ...
  const BuyStocks({Key key, this.StockName, this.Exchange, this.TransactionType, this.Price, this.TradingSymbol}) : super(key: key);

  @override
  _BuyStocksState createState() => _BuyStocksState(StockName: StockName,TradingSymbol: TradingSymbol,TransactionType: TransactionType,Price: Price,Exchange: Exchange);
}
...
class _BuyStocksState extends State<BuyStocks> {
  ...
  Future<http.Response> createStock(String price,String quantity) async {
    ...
    return http.post(
      Uri.parse('http://stockapp.techverden.com/api/v1/market/stock?tradingsymbol=ITC.XBOM&exchange=BSE&transaction_type=Sell&order_type=&quantity=&product=Reliance&price=300'),
  ...
  _BuyStocksState({Key key, this.StockName, this.Exchange, this.TransactionType, this.Price, this.TradingSymbol});
