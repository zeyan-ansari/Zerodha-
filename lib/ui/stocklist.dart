...
import 'package:zerodhaui/Models/dbhelper.dart';
...
Future<String> loadStockAsset() async {
  return await rootBundle.loadString('assets/stock.json');
}
                        ...
                        Navigator.of(context).push(
                            new MaterialPageRoute(
                              ...
                              builder: (BuildContext context) {
                                print(favs[index].symbol);
                                return  new WatchList1(stockName: favs[index].symbol);
                              },
                            )
                        );
                      },
                ...
                return FlatButton(
                  child: new ListTile(
                    ...
                    leading: Container(
                      ...
                      child: Text('NSE',style: TextStyle(color: Colors.blueAccent,fontSize: 12),),
                    ),
                  ),
                  onPressed: () {
